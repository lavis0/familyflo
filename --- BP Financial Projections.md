Revenue streams, cost analysis, funding requirements, and financial forecasts.

**To-do:**
- Consider materials/resources costs in greater detail.
- Consider how costs change over time, which are fixed/variable, etc
- First year burn rate so that we can discuss funding requirements.
# Costs
